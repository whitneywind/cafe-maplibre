...
// export function normalizeCafe(cafe: NewCoffeeShop) {
//   return {
//     id: cafe.id,
//     name: cafe.name || "",
//     address: cafe.address || "",
//     coordinates: cafe.coordinates || [0, 0],
